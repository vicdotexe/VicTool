...
namespace VicTool.Main.Eth
{
    ...
    public partial class WAVAXFunction : WAVAXFunctionBase
    {
    }

    [Function("WAVAX", "address")]
    public class WAVAXFunctionBase : FunctionMessage
    {
    ...
    {
        [Parameter("address", "token", 1)] public virtual string Token { get; set; }
    ...
    {
        [Parameter("uint256", "amountOut", 1)] public virtual BigInteger AmountOut { get; set; }
    ...
    {
        [Parameter("uint256", "amountIn", 1)] public virtual BigInteger AmountIn { get; set; }
        [Parameter("uint256", "reserveIn", 2)] public virtual BigInteger ReserveIn { get; set; }
    ...
    {
        [Parameter("uint256", "amountA", 1)] public virtual BigInteger AmountA { get; set; }
    ...
    {
        [Parameter("uint256[]", "amounts", 1)] public virtual List<BigInteger> Amounts { get; set; }
    }
    ...
    {
        [Parameter("uint256", "amountB", 1)] public virtual BigInteger AmountB { get; set; }
    }
